...
public class Eletroposto {
    ...
    public String toString() {
        return String.format(
                "[ID: %d] %s | Local: %s | CidadeID: %d | Conectores: %s | %.1f kW | R$ %.2f/kWh | Vagas: %d",
                id, nome, localizacao, cidadeId, tiposConectoresDisponiveis,
                potenciaCargaKw, precoPorKwh, vagasDisponiveis
        );
    }
}
